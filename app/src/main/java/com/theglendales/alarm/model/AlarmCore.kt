...
import com.theglendales.alarm.statemachine.ComplexTransition
import com.theglendales.alarm.statemachine.State
import com.theglendales.alarm.statemachine.StateMachine
import com.theglendales.alarm.stores.modify
...
class AlarmCore(
    ...
    private fun broadcastAlarmState(action: String, calendar: Calendar? = null) {
        Log.d(TAG, "broadcastAlarmState: called.")
